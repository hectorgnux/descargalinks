...
# Modificado para aceptar solo archivos .txt y preguntar por directorio de almacenamineto Créditos: Telegram @hinakawa
...
def main():
    ...
    download_path = input("Ingrese el directorio donde guardara los archivos: ")
