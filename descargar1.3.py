...
# Modificado para aceptar solo archivos .txt, validar extensiones vacias a traves del mime type, y validar que 
# los archivos identificados como texto plano no sean objetos 3d, preguntar por directorio de almacenamiento 
